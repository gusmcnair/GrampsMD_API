...
VALUES
    ('I had that for an entire year in the early 1970s!', 'Oh yeah, I remember it well. I was working at the cement plant – not Gunderson’s, this was after Gunderson’s – and every morning I would have the worst headache, and usually I’d throw up three or four times during the day. Your grandmother wanted me to go in and see the doctor, but I was pretty sure it would go away on its own. Sure enough, fourteen months later, it vanished without a trace!', 'Get over it.', 'oldmansad'),
    ...
    ('You need to call Grandma and I more often!', 'I bet all your symptoms would disappear overnight if you just gave us a ring every now and again. You know we love you, young !gender!, and we’re not going to be around forever.', ' You kids carry your phones around with you all day, why don’t you try using them?', 'oldmansad'),
    ...
    ('Young lady, you’re hysterical!', 'Sounds like your female hormones are all discombobulated and it’s causing your brain to go all out of whack. This happens to your grandmothr from time to time, doesn’t it, Mildred? Ow! What did I say?', 'I’ll put you in touch with a good lobotomist.', 'oldmanchild'),
    ('Time to get dentures', 'Losing my original teeth is the best thing that every happened to me. My fancy new dentures can bite through anything, and best of all, I don’t have to go to the dentist anymore or anything!', 'I’ve got a rusty pair of pliers right here, you want to do this right now? Open wide!', 'oldmanhappy'),
    ('Pipe down! My favorite movie is on the teevee!', '<i>Bob Hope and Bing Crosby Get Trapped In The Bread Factory</i> is a laugh-a-minute 1958 comedy about two GIs on leave who accidentally wander into a condemned bread factory. Unable to leave, Bob Hope (played by Bing Crosby) medicates his depression by eating hundreds of loaves of bread daily, while Bing Crosby (played by Bob Hope) develops Stockholm Syndrome and falls in love with a baguette who he names Louise. Their conflict comes to a head when Bob attempts to consume Bing’s lover, leading to a knock-down, drag-out fight that leaves both dead. The whole thing is then revealed to be a dream had by Elvis Presley (played by Bob Hope and Bing Crosby at the same time).', 'We’ll talk during the ad break!', 'oldmanangry'),
    ...
    ('You need to find yourself a wife!', 'Don’t kid yourself with your swingin’ bachelor lifestyle, young !gender!. Life can be pretty lonesome, when you don’t got someone to share it with. Plus, everyone knows that men are consistutionally unfit for cooking and cleaning!', 'Back in my day you’d go down to the local malt shop to meet girls. I assume that’s still how it works?', 'oldmanexplain'),
